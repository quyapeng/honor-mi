<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column min-width="180px" label="分类">
        <template slot-scope="{ row }">
          <span v-for="(c, index) in row.classify" :key="c">
            {{ c }}
...
import { getPlayers, deletePlayers } from "../../api/players";
